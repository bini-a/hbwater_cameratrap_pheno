...
When finished, export your annotations as a `.csv` and `.json` file for use in the machine learning model. Here is an example CSV-file output, containg information about the file and
region attributes.
