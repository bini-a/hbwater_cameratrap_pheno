...
This section details the creation of the first region of interest as well as the dynamics behind image masking.

#### Creating First Region of Interest
The first image file in image_file_list is plotted, allowing the user to draw the first region of interest (see section `RoiPoly Instruction` for details).

```{r image-mid-creation, echo = FALSE}
knitr::include_graphics("/Users/hecon/Documents/BOOKDOWN/bookdown/imgs/roi_drawing_initial.png")
```
...
knitr::include_graphics("/Users/hecon/Documents/BOOKDOWN/bookdown/imgs/confirmbutton.png")
```
...
knitr::include_graphics("/Users/hecon/Documents/BOOKDOWN/bookdown/imgs/restartmasking.png")
```
...
knitr::include_graphics("/Users/hecon/Documents/BOOKDOWN/bookdown/imgs/previousnext.jpg")
```
...
knitr::include_graphics("/Users/hecon/Documents/BOOKDOWN/bookdown/imgs/finishmasking.jpg")
```
...
#knitr::include_graphics("path to screenshot")# screenshot of wateryear folder output
```
...
#knitr::include_graphics("path to screenshot")# screenshot of mask id to associated mask dataframe
```

Here is an example dataframe that stores each `mask_id` to its associated date. 
```{r Dataframe-date-id, echo = FALSE}
#knitr::include_graphics("path to screenshot")# screenshot of date to mask id dataframe
```
